 ...
 */
@Configuration
public class AchieveListPushActMQConfig implements IWxMQConfig {
    ...
    @Bean
    FanoutExchange achieveListPushActMsgExchanges() {
...
//            String appid = wxAuthorizers.get(i).getAppid();
        return rabbitUtil.createFanoutExchange(StrUtil.EMPTY, StrUtil.EMPTY, QueueEnum.QUEUE_ACHIEVELISTRECORD_PUSHACT_MSG);
...
//        return list.toArray(fanoutExchanges);
     ...
     */
    @Bean
    public Queue achieveListPushActEventQueues() {
...
//            String appid = wxAuthorizers.get(i).getAppid();
           AchieveListPushActConsumer consumer = SpringContextUtil.getBean(AchieveListPushActConsumer.class);
            return  rabbitUtil.bindListener(StrUtil.EMPTY, QueueEnum.QUEUE_ACHIEVELISTRECORD_PUSHACT_MSG, consumer);
//            list.add(queue);
//        }
