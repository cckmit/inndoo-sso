 ...
 */
@Slf4j
public class InndooGenerator {

    /**
     * 实体类名
     * 建议仅需修改
     */
    private static final String className = "SmsCaptchaLog";

    /**
     * 类说明描述
     * 建议仅需修改
     */
    private static final String description = "手机短信验证码日志";

    private static final Boolean isCreation = true;

    /**
     * 作者名
     * 建议仅需修改
     */
    private static final String author = "Nolan";
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.ytdinfo.inndoo.modules.core.dao";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "com.ytdinfo.inndoo.modules.core.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "com.ytdinfo.inndoo.modules.core.serviceimpl";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //模板路径
        String root =  basePath + "/src/main/java/com/ytdinfo/inndoo/generator/template";
        FileResourceLoader resourceLoader = new FileResourceLoader(root,"utf-8");
        Configuration cfg = Configuration.defaultConfiguration();
        GroupTemplate gt = new GroupTemplate(resourceLoader, cfg);
        if(isCreation){
            //生成代码
            generateCode(gt,"/../inndoo-web-admin");
        }else{
            //根据类名删除生成的代码
            deleteCode(className,"/../inndoo-web-admin");
        }
    }
     ...
     * @throws IOException
     */
    private static void generateCode(GroupTemplate gt,String controllerPath) throws Exception{
        ...
        entity.setClassNameAllLowerCase(className.toLowerCase());
        ...
        log.info(daoResult);
        //创建文件
        String daoFileUrl = basePath+"/src/main/java/"+ dotToLine(daoPackage) + "/" +className + "Dao.java";
        ...
        //创建文件
        String serviceFileUrl = basePath+"/src/main/java/"+ dotToLine(servicePackage) + "/" + className + "Service.java";
        ...
        //创建文件
        String serviceImplFileUrl = basePath+"/src/main/java/"+ dotToLine(serviceImplPackage) + "/" + className + "ServiceImpl.java";
