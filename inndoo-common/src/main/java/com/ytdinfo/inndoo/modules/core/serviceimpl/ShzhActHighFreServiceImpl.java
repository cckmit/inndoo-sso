...
/**
 * 获取上海中行[查询活动参与权限_是否为上一年度手机银行交易高频用户]
 */
public class ShzhActHighFreServiceImpl implements DynamicApiBaseService<String> {
   ...
   // @Autowired
    ...
    public Result<String> getValue(DynamicApiDto dto) {
        return dealDifferentType("highFre",dto.getAccountId());
    }
