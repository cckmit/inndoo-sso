...
@Data
@Entity
@Table(name = "t_limit_list")
@TableName("t_limit_list")
@ApiModel(value = "受限名单")
@SQLDelete(sql = "update t_limit_list set is_deleted=1 where id=?")
@Where(clause = "is_deleted=0")
public class LimitList extends BaseWechatEntity {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "受限名单名称")
