...
@Data
@Entity
@Table(name = "t_limit_list_extend_record")
@TableName("t_limit_list_extend_record")
@ApiModel(value = "受限名单扩展信息清单")
@SQLDelete(sql = "delete from t_limit_list_extend_record  where id=?")
@Where(clause = "is_deleted=0")
public class LimitListExtendRecord extends BaseWechatEntity {
    ...
    @ApiModelProperty(value = "受限名单RecordId")
    @Column(length = 19, nullable = false)
