...
/**
 * 获取上海中行[查询活动参与权限_是否为上海中行手机银行用户]
 */
public class ShzhActShMobServiceImpl implements DynamicApiBaseService<String> {
   ...
   //@Autowired
    ...
    public Result<String> getValue(DynamicApiDto dto) {
        return dealDifferentType("shMob",dto.getAccountId());
    }
