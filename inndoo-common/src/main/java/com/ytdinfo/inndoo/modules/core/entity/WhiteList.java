...
@ApiModel(value = "白名单")
@SQLDelete(sql = "update t_white_list set is_deleted=1 where id=?")
@Where(clause = "is_deleted=0")
public class WhiteList extends BaseWechatEntity {
    ...
    @ApiModelProperty(value = "名单类型，0：高级校验，1：微信用户openid，2：phone，3：小核心accountid，4:活动平台accountid,5:帐号openid")
