...
public class WaterMarkHandler extends AbstractColumnWidthStyleStrategy implements SheetWriteHandler {
    ...
    @Override
    protected void setColumnWidth(WriteSheetHolder writeSheetHolder, java.util.List<CellData> list, Cell cell, Head head, Integer integer, Boolean aBoolean) {
        // 简单设置
