...
import com.ytdinfo.inndoo.common.vo.IpInfo;
import com.ytdinfo.inndoo.common.vo.IpLocate;
...
public class IpInfoUtil {
    ...
    @XxlConf("core.inndoo.mob.appkey")
    ...
    public String getIpCity(String ip){
        ...
        if(null != ip){
            ...
            String result="未知";
            try{
                String json= HttpRequestUtil.get(url);
