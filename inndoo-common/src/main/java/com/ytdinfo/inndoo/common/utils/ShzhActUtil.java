...
public class ShzhActUtil {
    ...
    public  static  String getUuid(String accountId){
        String uuid= "";
...
//        String resultStr = HttpRequestUtil.post(url, headers, bodyJson);
    ...
    /**生成token*/
    public static String getToken(String uuid,String projectid){
        String token = "";
...
//            System.out.println("从令牌中取出的签发时间：" + claims1.getIssuedAt());
    ...
    /**上海中行[查询活动参与权限]接口交互*/
    public static String getShzhActPermission(String uuid,  String token){
        String resultStr ="";
        try {
    ...
    /**处理上海中行下一个动态接口*/
    public static Result<String> dealDifferentType(String type,String accountId){
