...
import com.ytdinfo.inndoo.common.utils.FileHeaderUtil;
...
import com.ytdinfo.inndoo.modules.activiti.service.ActModelService;
...
@RequestMapping("/activiti/actModel")
public class ActModelController {
    ...
    public Result<Object> create(@ModelAttribute ActModel actModel){
    ...
    public void export(@PathVariable String id, HttpServletResponse response) {
        ...
        try {
            ...
            if (nodeBytes == null) {
                throw new InndooException("导出失败，模型数据为空");
            }
            ...
            log.error(e.toString());
            throw new InndooException("导出模型出错");
        }
    }

    @RequestMapping(value = "/listByCondition", method = RequestMethod.GET)
    @ApiOperation(value = "多条件分页获取")
    public Result<Page<ActModel>> listByCondition(@ModelAttribute ActModel actModel,
